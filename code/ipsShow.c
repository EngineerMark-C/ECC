...
void Ips_show(void)
{
    ips114_show_float(0, 0, pid_speed.target, 5, 2);     // 目标值
    ips114_show_float(0, 16, speed, 5, 2);         // 当前速度
    ips114_show_float(0, 32, pid_speed.error, 5, 2);     // 误差
    ips114_show_float(0, 48, pid_speed.integral, 5, 2);  // 积分项
    ips114_show_int(0, 64, output_speed, 5);             // 输出值
