...
"code/control.src":"../code/control.c" "code/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc26xb "-fD:/code/20/TC264_Library/Example/ECC/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=1 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<"
...
clean-code:
	-$(RM) ./code/control.d ./code/control.o ./code/control.src ./code/encoder.d ./code/encoder.o ./code/encoder.src ./code/flash.d ./code/flash.o ./code/flash.src ./code/gps.d ./code/gps.o ./code/gps.src ./code/imu.d ./code/imu.o ./code/imu.src ./code/init.d ./code/init.o ./code/init.src ./code/ipsShow.d ./code/ipsShow.o ./code/ipsShow.src ./code/menu.d ./code/menu.o ./code/menu.src ./code/motor.d ./code/motor.o ./code/motor.src ./code/pid.d ./code/pid.o ./code/pid.src ./code/sreer.d ./code/sreer.o ./code/sreer.src ./code/uartReceiver.d ./code/uartReceiver.o ./code/uartReceiver.src
