...
clean-code:
	-$(RM) ./code/button.d ./code/button.o ./code/button.src ./code/encoder.d ./code/encoder.o ./code/encoder.src ./code/imu.d ./code/imu.o ./code/imu.src ./code/init.d ./code/init.o ./code/init.src ./code/motor.d ./code/motor.o ./code/motor.src ./code/pid.d ./code/pid.o ./code/pid.src ./code/sreer.d ./code/sreer.o ./code/sreer.src
